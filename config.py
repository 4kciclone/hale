...
HALE_CONFIG = {
    'L': 5, 'J': 5, 'd_r': 512, 'd_s': 256,
    'alpha_list': [0.1, 0.3, 0.5, 0.7, 0.9],
    'rho_list': [0.5, 0.7, 0.85, 0.9, 0.97],
    'beta': 0.1, 'gamma': 0.1, 'eta': 1e-3,
    'N_free': 5, 'N_nudge': 10, 'kappa': 2.0,
    'lam': 0.01, 'eps': 1e-6, 'delta': 0.01,
    'clip_alpha': 5.0, 'rls_delta': 1.0, 'rls_lambda': 1.0,
}
